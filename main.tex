...
{\begin{itemize}
  \item Serie de proyectos orientados al desarrollo web. Entre ellos: drum machine, reloj pomodoro, app del clima. 
  \item Javascript, React, Redux, D3, HTML, CSS, Node, Express, MongoDB, entre otras. Repo en github: \href{https://github.com/sebport0/fcc-projects}{fcc-projects}.
\end{itemize}
}
